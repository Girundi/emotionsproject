...
def load_video(video, num_fps):
    ...
    ret = True
    count_frames = 0
    os.chdir(r"/Users/yerinaaa/DL/prj/RetinaFace/code/images_video/frames")
...
def make_video(count_frames, num_fps):
    ...
    for i in range(count_frames):
        image_path = ("/Users/yerinaaa/DL/prj/RetinaFace/code/images_video/detect_frames/detect_frame %d.jpg" % i)
        filelist.append(image_path)
    frames = [cv2.imread(fname) for fname in filelist]

    writer = cv2.VideoWriter(
        '/Users/yerinaaa/DL/prj/RetinaFace/code/output.mp4',
...
#     count_frames = load_video(video, num_fps)
    ...
    for i in range(count_frames):
        count_crop = 0
        image_path = ("/Users/yerinaaa/DL/prj/RetinaFace/code/images_video/frames/frame %d.jpg" % i)
...
#                 cv2.circle(img_raw, (b[13], b[14]), 1, (255, 0, 0), 4)
            # save image
#             os.chdir(r"/Users/yerinaaa/DL/prj/RetinaFace/code/images_video/detect_frames")
